...
const devWebpackConfig = merge(baseWebpackConfig, {
  module: {
    rules: utils.styleLoaders({ sourceMap: config.frontend.cssSourceMap, usePostCSS: true })
  },
  ...
  devServer: {
    ...
    historyApiFallback: {
      rewrites: [
        { from: /.*/, to: path.posix.join(config.frontend.assetsPublicPath, 'index.html') },
      ],
    },
    hot: true,
    ...
    overlay: config.frontend.errorOverlay
